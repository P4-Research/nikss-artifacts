/* Automatically generated by p4c-ebpf from p4testdata/01_use_cases/upf.p4 on Sat Dec  4 11:42:49 2021
 */
...
static __always_inline int process(SK_BUFF *skb, struct headers *hdr, struct psa_ingress_output_metadata_t *ostd, struct empty_t *resubmit_meta)
{
...
int tc_ingress_func(SK_BUFF *skb) {
    ...
    for (int i = 0; i < 4; i++) {
        ostd.resubmit = 0;
        ret = process(skb, (struct headers *) hdr, &ostd, &resubmit_meta);
